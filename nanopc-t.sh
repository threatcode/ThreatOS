#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for NanoPC-T3/T4 (64-bit)
...
# More information: https://threatcode.github.io/docs/arm/nanopc-t/
#
...
patch -p1 --no-backup-if-mismatch <${repo_dir}/patches/threatos-wifi-injection-4.4.patch
