#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Gateworks Newport (64-bit) - Cavium Octeon
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/gateworks-newport/
#
...
patch -p1 <${repo_dir}/patches/threatos-wifi-injection-5.4.patch
...
mkimage -f auto -A arm64 -O linux -T kernel -C gzip -n "Newport Threatos Kernel" -a 20080000 -e 20080000 -d arch/arm64/boot/Image.gz kernel.itb
