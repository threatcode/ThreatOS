#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for OrangePi 5 Plus (64-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/orangepi-5plus/
#
...
status_stage3 'Install threatos-sbc package'
