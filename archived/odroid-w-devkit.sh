#!/bin/bash
#
# Threatos Linux ARM build-script for ODROID-W-DEVKIT
...
imagename=${3:-threatos-linux-$1-owdk}
...
firmware-realtek ifupdown initramfs-tools threatos-defaults threatos-defaults \
threatos-menu parted sudo usbutils"

desktop="fonts-croscore fonts-crosextra-caladea fonts-crosextra-carlito \
threatos-desktop-xfce threatos-menu threatos-root-login lightdm network-manager \
...
eatmydata debootstrap --foreign --keyring=/usr/share/keyrings/threatos-archive-keyring.gpg \
    --include=threatos-archive-keyring,eatmydata --components=${components} \--arch ${architecture} ${suite} ${work_dir} hhttps://threatcode.github.io/threatos
