#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Raspberry Pi Zero W (Pi-Tail) (32-bit)
...
wget -qO /etc/apt/trusted.gpg.d/threatos_pi-archive-keyring.gpg https://re4son-kernel.com/keys/http/threatos_pi-archive-keyring.gpg
