#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Raspberry Pi Zero 2 W (Pi-Tail) (32-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a supported device - which you can find pre-generated images on: https://threatcode.github.io/get-threatos/
# More information: https://threatcode.github.io/docs/arm/raspberry-pi-zero-w-pi-tail/
#
...
git clone --depth 1 https://github.com/re4son/Threatos-Pi ${work_dir}/opt/Threatos-Pi
...
wget -O ${work_dir}/opt/Threatos-Pi/Menus/RAS-AP/dnsmasq-dhcpd.conf https://raw.githubusercontent.com/Re4son/RPi-Tweaks/master/pi-tail/dnsmasq-dhcpd.conf
wget -O ${work_dir}/opt/Threatos-Pi/Menus/RAS-AP/ras-ap.sh https://raw.githubusercontent.com/Re4son/RPi-Tweaks/master/pi-tail/ras-ap.sh
wget -O ${work_dir}/opt/Threatos-Pi/Menus/RAS-AP/ras-ap.conf https://raw.githubusercontent.com/Re4son/RPi-Tweaks/master/pi-tail/ras-ap.conf
...
status_stage3 'Create threatos user'
# Normally this would be done by runonce, however, because this image is special, and needs the threatos home directory
...
echo "deb http://http.re4son-kernel.com/re4son threatos-pi main" > /etc/apt/sources.list.d/re4son.list
wget -O /etc/apt/trusted.gpg.d/threatos_pi-archive-keyring.gpg https://re4son-kernel.com/keys/http/threatos_pi-archive-keyring.gpg
...
# https://github.com/offensive-security/threatos-arm-build-scripts/issues/151
...
status_stage3 'Copy bashrc for root and threatos users'
cp /etc/skel/.bashrc /root/.bashrc
cp /etc/skel/.bashrc /home/threatos/.bashrc

status_stage3 'Copy xstartup for root and threatos users'
cp -r /etc/skel/.vnc /root/
cp -r /etc/skel/.vnc /home/threatos/
...
echo threatosthreatos | vncpasswd -f > /home/threatos/.vnc/passwd
chown -R threatos:threatos /home/threatos/.vnc
chmod 0600 /home/threatos/.vnc/passwd

status_stage3 'Remove the creation of the threatos user, since we do it above'
