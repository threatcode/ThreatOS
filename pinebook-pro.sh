#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Pinebook Pro (64-bit)
...
# More information: https://threatcode.github.io/docs/arm/pinebook-pro/
#
...
eatmydata apt-get install -y dkms threatos-sbc-rockchip linux-image-arm64
