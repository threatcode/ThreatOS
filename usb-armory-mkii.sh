#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for USB Armory MKII (32-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/usb-armory-mkii/
#
...
patch -p1 --no-backup-if-mismatch <${repo_dir}/patches/threatos-wifi-injection-5.15.patch
