#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for CuBox-i4Pro (32-bit) - Freescale based NOT the original Marvell based
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/cubox-i4pro/
#
