...
# Additionally, exclude standard packages that are not present in the ThreatOS
# images created by the ThreatOS installer (the reason why they're not present
# is unknown).
