#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Raspberry Pi Zero W (P4wnP1 A.L.O.A.) (32-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/raspberry-pi-zero-w-p4wnp1-aloa/
#
...
# which is used to build the threatos armel packages itself, which is hopefully available for linux-x64)
#
