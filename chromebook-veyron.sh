#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Chromebook (Veyron ASUS Flip) (32-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/chromebook-veyron/
#
...
image_name=${3:-threatos-linux-$1-chromebook-veyron}
...
extras="alsa-utils bc bison bluez bluez-firmware florence threatos-linux-core \
...
touch .scmversion
patch -p1 --no-backup-if-mismatch <${base_dir}/../patches/veyron/4.19/threatos-wifi-injection.patch
