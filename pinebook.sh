#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Pinebook (64-bit)
...
# More information: https://threatcode.github.io/docs/arm/pinebook/
#
...
eatmydata apt-get install -y dkms threatos-sbc-allwinner linux-headers-arm64 linux-image-arm64
