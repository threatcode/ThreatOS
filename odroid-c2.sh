#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for ODROID-C2 (64-bit)
...
# More information: https://threatcode.github.io/docs/arm/odroid-c2/
#
...
eatmydata apt-get install -y dkms threatos-sbc-amlogic linux-image-arm64
