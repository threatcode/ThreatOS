...
# NetHunter ~ https://github.com/threatcode/nethunter/build-scripts/threatos-nethunter-project/-/blob/2e26ee29/nethunter-installer/prep-release.py
# ARM Devices ~ https://github.com/threatcode/threatos/-/blob/master/devices.yml

###############################################
# Script to prepare Threatos ARM quarterly release
#
