...
# ARM Devices ~ https://github.com/threatcode/threatos/-/blob/master/devices.yml

###############################################
# Script to prepare the rpi-imager json script for Threatos ARM quarterly releases.
...
def jsonarray(devices, vendor, name, url, extract_size, extract_sha256, image_download_size, image_download_sha256, device_arch):
    ...
    jsondata = {
        "name": name,
        "description": f"Threatos Linux ARM image for the {name}",
        "url": url,
        "icon": "https://threatcode.github.io/images/threatos-linux-logo.svg",
        "website": "https://threatcode.github.io/",
                        ...
                        for image in board[key]:
                            ...
                            if image.get("support") == "threatos":
                                ...
                                if name not in img_seen:
                                    ...
                                    filename = f"threatos-linux-{release}-{image.get('image', default)}"
                                    ...
                                    url = f"https://threatos.download/arm-images/threatos-{release}/{filename}.xz"
