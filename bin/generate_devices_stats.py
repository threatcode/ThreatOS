...
def write_file(data, file):
    try:
        with open(file, "w") as f:
            meta = "---\n"
            meta += "title: Threatos ARM Device Statistics\n"
            meta += "---\n\n"

            stats = f"- The official [Threatos ARM repository](https://github.com/threatcode/threatos) contains [build-scripts]((https://github.com/threatcode/threatos)) to support [**{qty_devices}** Threatos ARM devices](devices.html)\n"
