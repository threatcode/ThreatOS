...
def write_file(data, file):
    try:
        with open(file, "w") as f:
            meta = "---\n"
            meta += "title: Threatos ARM Devices\n"
            meta += "---\n\n"

            stats = f"- The official [Threatos ARM repository](https://github.com/threatcode/threatos) contains build-scripts to support [**{qty_devices}** Threatos ARM devices](device-stats.html)\n"
