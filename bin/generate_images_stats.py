...
def write_file(data, file):
    try:
        with open(file, "w") as f:
            meta = "---\n"
            meta += "title: Threatos ARM Image Statistics\n"
            meta += "---\n\n"

            stats = "- The official [Threatos ARM repository](https://github.com/threatcode/threatos) contains [build-scripts]((https://github.com/threatcode/threatos)) to create [**{}** unique Threatos ARM images](images.html)\n".format(str(qty_images))
