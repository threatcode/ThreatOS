#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for ODROID-XU3 (32-bit)
...
# More information: https://threatcode.github.io/docs/arm/odroid-xu3/
#
...
patch -p1 --no-backup-if-mismatch <${repo_dir}/patches/threatos-wifi-injection-4.14.patch
