#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Trimslice (32-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/trimslice/
#
...
# And we remove the "Debian GNU/Linux because we're Threatos"
sed -i -e "s/Debian GNU\/Linux/Threatos Linux/g" ${work_dir}/boot/extlinux/extlinux.conf
