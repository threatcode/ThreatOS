#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Chromebook 1/2 (Exynos Samsung daisy_snow/peach_pi/peach_pit & HP daisy_spring) (32-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/chromebook-exynos/
#
...
image_name=${3:-threatos-linux-$1-chromebook-exynos}
