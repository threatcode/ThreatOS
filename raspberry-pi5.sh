#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Raspberry Pi 5 (64-bit)
...
# More information: https://threatcode.github.io/docs/arm/raspberry-pi-5/
#
...
patch -p1 --no-backup-if-mismatch <${repo_dir}/patches/threatos-wifi-injection-6.1.patch
