#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for RIoTboard (32-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/riotboard/
#
...
image_name=${3:-threatos-linux-$1-riotboard}
...
int uname(struct utsname *buf)
{
    ...
    strcpy(buf->release, "5.7.0-threatos1-armmp");
...
#cat << __EOF__ > "${base_dir}"/threatos-$architecture/boot/bootscript
#fdt_high=0xffffffff
