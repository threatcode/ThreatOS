#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Mini-X (32-bit)
# Source: https://github.com/threatcode/threatos
#
# This is a community script - you will need to generate your own image to use
# More information: https://threatcode.github.io/docs/arm/mini-x/
#
...
image_name=${3:-threatos-linux-$1-mini-x}
...
firmware-realtek ifupdown initramfs-tools threatos-defaults threatos-menu \
