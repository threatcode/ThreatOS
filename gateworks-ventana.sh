#!/usr/bin/env bash
#
# Threatos Linux ARM build-script for Gateworks Ventana (32-bit) - Freescale based
...
# More information: https://threatcode.github.io/docs/arm/gateworks-ventana/
#
...
patch -p1 <${repo_dir}/patches/veyron/4.19/threatos-wifi-injection.patch
